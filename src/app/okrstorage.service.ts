...
const BUCKETS: Bucket[] = [
  { id: 'a', displayName: 'First bucket', allocationPercentage: 40, objectives: [
  ...
  { id: 'b', displayName: 'Second bucket', allocationPercentage: 40, objectives: [
    { name: 'A bucket 2 thing', resourceEstimate: 12 },
    { name: 'Another bucket 2 thing', resourceEstimate: 1 },
  ] },
  { id: 'c', displayName: 'Third bucket', allocationPercentage: 20, objectives: [
